  ...
  return (
    <footer className="relative mt-12 overflow-hidden text-slate-600 dark:text-[#B8B3AF] transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white/95 dark:bg-[#101420]/95 backdrop-blur-xl border border-white/80 dark:border-white/10 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_15px_40px_rgba(0,0,0,0.05)] space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 items-start">
              ...
              <ul className="space-y-2 text-xs font-semibold">
                ...
                <li>
                  ...
                  >
                    ...
                    <span>{isHindi ? '30+ टूल्स कैटलॉग' : '30+ Utilities Catalog'}</span>
                  </button>
                </li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2 space-y-3.5">
              ...
              <ul className="space-y-2 text-xs font-semibold">
                <li>
                  ...
                  >
                    {isHindi ? 'सभी उपकरण (All Tools)' : 'All Tools'}
                  </button>
                </li>
                <li>
                  <button
                    ...
                    className="flex items-center gap-1.5 text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer text-left"
                  >
                    <span>{isHindi ? 'करियर और हायरिंग' : 'Careers & Hiring'}</span>
                ...
                <li>
                  <button
                    ...
                    className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer text-left"
                  >
                    {isHindi ? 'संस्थापक' : 'Founder (Anurag Gurauli)'}
                  </button>
                </li>
              </ul>
            </div>
              ...
              <ul className="space-y-2 text-xs font-semibold">
                ...
                <li>
                  <button
                    ...
                    className="text-red-500 hover:underline hover:text-red-600 transition-colors cursor-pointer text-left font-bold animate-pulse"
                  >
                    {isHindi ? 'खाता हटाएं' : 'Delete Account & Data'}
                  </button>
                </li>
              </ul>
            </div>

            {/* Column 5: Connect & Get the App (Span 2) */}
            <div className="lg:col-span-2 space-y-4">
              ...
              {/* Get the App Badge */}
              <div className="pt-2">
                <div className="bg-slate-50 dark:bg-white/5 border border-slate-200/70 dark:border-white/10 rounded-2xl p-3 space-y-2">
                  <span className="text-[10px] font-bold text-slate-500 block uppercase tracking-wider">
                    {isHindi ? 'एंड्रॉइड ऐप' : 'Get Less Legal'}
                  </span>
                  <a
                    href={SITE_CONFIG.playStoreUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 py-2 px-3 rounded-xl bg-slate-900 hover:bg-black text-white text-xs font-bold transition-colors shadow-xs"
                  >
              ...
              <div className="pt-1 text-[11px] text-slate-500">
                ...
                <a href="mailto:support@lesscreation.com" className="text-blue-600 dark:text-blue-400 hover:underline">
          ...
          <div className="pt-5 border-t border-slate-200/60 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
            {/* Copyright Statement */}
            <div className="text-slate-500 dark:text-slate-400 text-center md:text-left space-y-0.5">
              <p 
                onClick={handleSecretLockClick}
                className="font-bold select-none cursor-default text-slate-700 dark:text-slate-300"
              >
            ...
            {/* Quality Statement / Trust Badge */}
            <div className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-blue-500/5 dark:bg-blue-500/10 border border-blue-500/10 dark:border-blue-400/10 shadow-2xs">
        ...
        {/* Bottom Slogan & Page Terminus - Clean, tight bottom padding with NO large empty space */}
        <div className="pt-5 pb-5 text-center flex flex-col sm:flex-row items-center justify-center gap-2 border-t border-slate-200/30 dark:border-white/5 mt-5">
          <p className="text-[10px] sm:text-[11px] font-bold text-blue-600/70 dark:text-blue-400/70 tracking-[0.2em] sm:tracking-[0.25em] uppercase select-none">
            BUILDING A SIMPLER, SMARTER AND MORE INFORMED INDIA ❤️
          </p>
          <button
            onClick={handleSecretLockClick}
            className="opacity-10 hover:opacity-50 transition-opacity p-1 text-slate-400 dark:text-slate-600 focus:outline-none cursor-pointer"
