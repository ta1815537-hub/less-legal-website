...
export const FloatingLanguageButton: React.FC = () => {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-4 sm:bottom-8 sm:right-6 md:hidden z-50 px-3.5 py-2.5 rounded-full bg-slate-900/90 dark:bg-[#0D0D0F]/95 text-white border border-amber-500/40 dark:border-[#D8BD82]/50 shadow-lg shadow-black/20 backdrop-blur-xl flex items-center gap-2 cursor-pointer transition-all duration-300 group"
