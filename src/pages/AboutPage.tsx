    ...
    <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-12 overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch relative z-10">
        ...
        <ScrollReveal direction="left" delay={0.1} className="h-full">
          <div className="card-interactive neo-box p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 shadow-xs space-y-4 flex flex-col justify-between h-full">
      ...
      <div className="space-y-6 relative z-10">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <StaggerItem>
            <div className="card-interactive p-6 bg-white rounded-2xl border border-slate-200 shadow-xs space-y-3 h-full">
