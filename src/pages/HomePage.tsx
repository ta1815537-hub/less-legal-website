    ...
    <div className="space-y-20 sm:space-y-28 py-8 sm:py-12 overflow-hidden">
              ...
              <StaggerItem key={product.id}>
                <div className={`group relative p-6 rounded-3xl border transition-all duration-300 h-full flex flex-col ${
                  isFlagship 
                    ...
                    : 'bg-white dark:bg-slate-900 border-slate-200/80 hover:border-slate-300 hover:shadow-lg hover:shadow-slate-200/50'
                }`}>
                  ...
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 transition-transform group-hover:scale-110 ${
                    isFlagship ? 'bg-indigo-500/20 text-indigo-300' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400'
                  }`}>
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className={`text-xl font-bold ${isFlagship ? 'text-white' : 'text-slate-900 dark:text-white'}`}>
                        {product.name}
                      </h3>
                      {!isAvailable && (
                    ...
                    <p className={`text-sm leading-relaxed mb-6 ${isFlagship ? 'text-indigo-200' : 'text-slate-500 dark:text-slate-400'}`}>
                      {product.description}
                    </p>
                  </div>
                  ...
                  {isAvailable ? (
                    ...
                    <button disabled className="w-full py-3 rounded-xl text-sm font-bold bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-700/50 text-slate-400 flex items-center justify-center gap-2 cursor-not-allowed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex">
            ...
            >
              {[...SITE_CONFIG.features.slice(0, 23), ...SITE_CONFIG.features.slice(0, 23)].map((feature, idx) => (
                <div key={`top-${idx}`} className="flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-slate-950 hover:bg-indigo-50 border border-slate-100 dark:border-slate-700/50 hover:border-indigo-100 rounded-xl whitespace-nowrap transition-colors">
          ...
          <div className="flex mt-4">
            ...
            >
              {[...SITE_CONFIG.features.slice(23, 46), ...SITE_CONFIG.features.slice(23, 46)].map((feature, idx) => (
                <div key={`bottom-${idx}`} className="flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-slate-950 hover:bg-purple-50 border border-slate-100 dark:border-slate-700/50 hover:border-purple-100 rounded-xl whitespace-nowrap transition-colors">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <StaggerItem>
            <div className="card-interactive bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-xs flex flex-col justify-between h-full">
              <div>
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">PDF Tools & Less Share</h3>
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700/50 text-xs text-indigo-600 font-semibold flex items-center justify-between">
          ...
          <StaggerItem>
            <div className="card-interactive bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-xs flex flex-col justify-between h-full">
              <div>
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Case Diary & Schedule</h3>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700/50 text-xs text-purple-600 font-semibold flex items-center justify-between">
          ...
          <StaggerItem>
            <div className="card-interactive bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-xs flex flex-col justify-between h-full">
              <div>
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Calculators & Knowledge</h3>
                <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700/50 text-xs text-blue-600 font-semibold flex items-center justify-between">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <ScrollReveal direction="up">
          <div className="neo-box p-8 sm:p-12 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-sm max-w-4xl mx-auto space-y-6">
            <motion.div 
