      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7">
          <div className="neo-box p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 shadow-xs">
            ...
            {submitted ? (
              <div className="p-6 bg-emerald-50 rounded-xl border border-emerald-200 text-center space-y-3 animate-in fade-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 px-6 rounded-xl bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white font-bold text-xs shadow-md shadow-indigo-600/30 flex items-center justify-center gap-2 transition-colors"
                >
