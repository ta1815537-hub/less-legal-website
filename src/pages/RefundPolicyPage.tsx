...
export const RefundPolicyPage: React.FC<RefundPolicyPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-10">
      ...
      {/* Overview Notice */}
      <div className="bg-slate-100/90 rounded-2xl p-6 border border-slate-200 dark:border-slate-700/80 space-y-2 text-xs text-slate-800 dark:text-slate-200">
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-bold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-700/80 pb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Plan 1 */}
          <div className="p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-xs space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-slate-900 dark:text-white text-sm">3 Months Pass (₹59)</h3>
          ...
          <div className="p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-xs space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-slate-900 dark:text-white text-sm">1 Year Pass (₹179)</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 text-xs text-slate-700 dark:text-slate-300">
          <div className="flex items-start gap-2.5 p-3.5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700/80">
            <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
            <div>
              <strong className="text-slate-900 dark:text-white block mb-0.5">Duplicate / Multiple Charges:</strong>
          ...
          <div className="flex items-start gap-2.5 p-3.5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700/80">
            <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
            <div>
              <strong className="text-slate-900 dark:text-white block mb-0.5">Payment Debited but Pass Not Activated:</strong>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-700/80 space-y-2 text-xs text-slate-700 dark:text-slate-300">
          <p>
