...
export const translations: Record<Language, TranslationSchema> = {
  ...
  hi: {
    ...
    common: {
      ...
      androidडाउनलोड: "एंड्रॉइड एप्लिकेशन डाउनलोड",
    ...
    home: {
      ...
      trustएंड्रॉइडReady: "एंड्रॉइड 7.0 से 15 तैयार",
      ...
      simWhatsऐपTitle: "डायरेक्ट व्हाट्सएप उपयोगिता",
      simWhatsऐपSub: "बिना नंबर सेव किए तुरंत व्हाट्सएप कानूनी नोटिस या संदेश भेजें।",
      simWhatsऐपBtn: "चैट शुरू करें",
    ...
    downloadPage: {
      ...
      reqएंड्रॉइडVer: "एंड्रॉइड 7.0 (नौगट) या उच्चतर",
