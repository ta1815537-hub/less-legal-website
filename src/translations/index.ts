...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    founder: {
      badge: "FOUNDER & CHIEF ARCHITECT",
      name: "Anurag Gurauli",
      role: "Advocate & Software Architect",
      subtitle: "Advocate, Allahabad High Court • Founder & Chief Architect, Less Creation",
      practice: "Practicing Advocate before the Allahabad High Court & Independent Software Architect.",
      shortQuote: "“Technology reaches its highest purpose not when it flaunts artificial complexity, but when it dissolves friction—empowering professionals and citizens with fast, private, and uncompromised utility.”",

      storyTitle: "Executive Founder Bio & Vision",
      storyP1: "Anurag Gurauli is an Advocate practicing before the Allahabad High Court, and the Founder & Chief Architect behind Less Creation and its flagship software suite, Less Legal. Operating at the unique nexus of active legal jurisprudence and software systems design, he is committed to engineering independent, accessible technology that dismantles systemic friction across professional workflows.",
      storyP2: "Years of ground-level litigation in high-volume judicial corridors provided firsthand clarity on a profound institutional challenge: legal practitioners, law clerks, students, and common citizens are routinely burdened by fragmented gazettes, convoluted reference portals, intrusive advertising, and expensive recurring subscription models. Anurag established Less Creation as a disciplined counter-force to bloated enterprise software.",
      storyP3: "Guided by a strict 'Privacy-by-Design' ethos, his architectural philosophy centers on on-device computations, zero corporate data monetization, and clean, high-performance interfaces. Every utility is engineered to execute reliably even without network connectivity, treating user time and confidentiality with the highest standard of care.",
      storyP4: "Less Legal is the premier realization of this vision—an integrated, courtroom-tested digital suite uniting statutory reference libraries, high-performance document tools, and precise legal calculators within a secure, sovereign environment.",
    ...
    about: {
      ...
      whatIsDesc: "Less Legal bridges the gap between complex legal workflows and everyday digital convenience, uniting statutory lookup, PDF tools, case diary, and GST calculators into a unified Android app.",
      ...
      p2Desc: "Ad-free access is offered through transparent one-time passes (₹99 for Lifetime Special Offer). We never perform hidden recurring subscription debits.",
    ...
    premiumPage: {
      ...
      notice1Text: "Premium passes grant ad-free access strictly for the duration purchased (Lifetime Permanent Access for ₹99).",
      ...
      features1Year: [
        "Lifetime ad-free continuous access",
        ...
        "GST Calculator & Legal Glossary",
        "Less Share local file transfer & Secure Vault",
    ...
    disclaimerPage: {
      ...
      sec2P2: "While reasonable efforts are made to keep reference information accurate and updated, statutory provisions, tax schedules, and regional procedural rules change over time. Users are strongly advised to independently verify all statutory texts, notifications, and fee calculations with official government gazettes or authoritative registries.",
      ...
      sec4Text: "Calculations performed by the GST Calculator, Land Unit Converter, and Calculator Hub are mathematical estimations based on standard formulas and regional conversion factors. Variations may exist depending on state-specific amendments, valuation rules, and judicial discretion. Less Legal assumes no responsibility for actions taken based on calculator outputs.",
      sec5Title: "5. Case Diary & Data Responsibility",
      sec5Text: "Case Diary and Vault store information locally on your device for personal organization. Users are responsible for verifying court dates directly on official e-Courts cause lists and maintaining independent backups of their case schedules.",
    ...
    termsPage: {
      ...
      disclaimerBannerText: "The materials, Bare Acts, calculation tools, tax estimators, and guides provided within Less Legal are for general reference and educational purposes only. Less Legal does not provide legal advice, representation, or formal legal opinions. No advocate-client relationship is formed. Users must independently verify statutory provisions with qualified legal professionals.",
      ...
      sec3Bullets: [
        "Available Pass: ₹99 for Lifetime Pass (Special Offer).",
      ...
      sec6Bullets: [
        ...
        "Any discrepancies in tax estimations, land unit conversions, or statutory text.",
    ...
    privacyPolicyPage: {
      ...
      sec5Text: "When purchasing a Premium Pass (₹99 for Lifetime Pass), financial transactions are processed by certified third-party payment gateways including Razorpay Software Private Limited and/or Google Play Billing.",
      sec5Bullets: [
    ...
    refundPolicyPage: {
      ...
      sec3P1: "Because Less Legal passes are one-time fixed-duration purchases and NOT auto-renewing subscriptions, there is no recurring billing cycle that requires future cancellation.",
      sec3P2: "Once your validity period concludes , your account automatically returns to standard access without any cancellation action needed from you.",
      ...
      sec4Bullets: [
        ...
        "Date and amount of the transaction (₹99).",
  ...
  hi: {
    ...
    founder: {
      badge: "संस्थापक एवं मुख्य वास्तुकार (CHIEF ARCHITECT)",
      name: "अनुराग गुरौली",
      role: "अधिवक्ता एवं डिजिटल वास्तुकार",
      subtitle: "अधिवक्ता, इलाहाबाद उच्च न्यायालय • संस्थापक एवं मुख्य वास्तुकार, लेस क्रिएशन",
      practice: "इलाहाबाद उच्च न्यायालय में प्रैक्टिसरत अधिवक्ता एवं स्वतंत्र सॉफ्टवेयर वास्तुकार।",
      shortQuote: "“तकनीक का वास्तविक गौरव कृत्रिम जटिलता प्रदर्शित करने में नहीं, बल्कि जटिलताओं को समाप्त करने में है—ताकि विधिक बिरादरी और आम नागरिक बिना किसी रुकावट के सशक्त बन सकें।”",

      storyTitle: "संस्थापक परिचय एवं विज़न (Executive Bio)",
      storyP1: "अनुराग गुरौली—इलाहाबाद उच्च न्यायालय में प्रैक्टिसरत अधिवक्ता एवं 'लेस क्रिएशन' (Less Creation) तथा इसके फ्लैगशिप सॉफ़्टवेयर 'लेस लीगल' (Less Legal) के संस्थापक व मुख्य वास्तुकार (Chief Architect) हैं। सक्रिय विधिक न्यायशास्त्र और आधुनिक सॉफ्टवेयर इंजीनियरिंग के संगम पर कार्य करते हुए, वे जटिल कानूनी प्रक्रियाओं, अदालती दस्तावेजीकरण और दैनिक डिजिटल उपयोगिताओं को सरल, सुरक्षित व सर्वसुलभ बनाने के लिए समर्पित हैं।",
      storyP2: "उच्च न्यायालय के दैनिक न्यायिक गलियारों और मुकदमों के प्रत्यक्ष अनुभव के दौरान, उन्होंने विधिक बिरादरी, शोधार्थियों और आम नागरिकों द्वारा झेली जाने वाली व्यवस्थागत चुनौतियों को गहराई से समझा। बिखरे हुए कानूनी स्रोत, असुविधाजनक टूल्स, अनगिनत विज्ञापनों और भारी-भरकम आवर्ती (recurring) सब्सक्रिप्शन फीस ने दैनिक कार्यप्रणाली को धीमा और बोझिल बना दिया था। अनुराग गुरौली ने इसी व्यवस्थागत जटिलता को समाप्त करने के संकल्प के साथ 'लेस क्रिएशन' की नींव रखी।",
      storyP3: "उनका स्थापत्य सिद्धांत 'प्राइवेसी-बाय-डिजाइन' और 'सारगर्भित सादगी' पर आधारित है—जहाँ उपयोगकर्ता का संवेदनशील डेटा किसी बाहरी सर्वर पर भेजे बिना सीधे ऑन-डिवाइस प्रोसेस होता है, किसी प्रकार का प्रोफाइलिंग या विज्ञापन नहीं होता, और हर सुविधा बिना इंटरनेट के भी त्वरित गति से निष्पादित होती है।",
      storyP4: "लेस लीगल (Less Legal) इसी चिंतन का प्रमुख फ्लैगशिप उत्पाद है—जो भारतीय कानूनों के प्रमाणित संदर्भों, मिलिट्री-ग्रेड पीडीएफ दस्तावेजीकरण और अचूक कानूनी व वित्तीय कैलकुलेटरों को एक एकीकृत, आत्मनिर्भर व पारदर्शी परिवेश में प्रस्तुत करता है।",
    ...
    home: {
      ...
      whyPillars: [
        ...
        },
        {
          ...
          desc: "जटिल तकनीक को समझना आसान होना चाहिए, चाहे कोई तकनीकी जानकार हो या दैनिक डिजिटल जीवन में मार्गदर्शन की तलाश में हो।"
        },
        {
          label: "04 · PRACTICAL KNOWLEDGE",
    ...
    about: {
      ...
      whatIsDesc: "लेस लीगल जटिल कानूनी वर्कफ़्लो और दैनिक डिजिटल सुविधा के बीच की दूरी को मिटाता है। यह कानूनी संदर्भों, पीडीएफ टूल्स, केस डायरी और जीएसटी कैलकुलेटर को एक एंड्रॉइड ऐप में जोड़ता है।",
      ...
      p2Desc: "विज्ञापन-मुक्त अनुभव पारदर्शी एक-बार पास (₹99 लाइफटाइम विशेष ऑफर) के माध्यम से दिया जाता है। कोई छिपी हुई आवर्ती कटौती नहीं है।",
    ...
    premiumPage: {
      ...
      notice1Text: "प्रीमियम पास खरीदी गई अवधि के लिए विज्ञापन-मुक्त पहुंच प्रदान करते हैं (₹99 में लाइफटाइम विशेष ऑफर)।",
      ...
      features1Year: [
        "आजीवन (Lifetime) विज्ञापन-मुक्त इंटरफ़ेस",
        ...
        "जीएसटी कैलकुलेटर एवं लीगल शब्दावली",
    ...
    disclaimerPage: {
      ...
      sec2P2: "यद्यपि संदर्भ जानकारी को सटीक और अद्यतित रखने के उचित प्रयास किए जाते हैं, फिर भी समय के साथ वैधानिक प्रावधानों, टैक्स शेड्यूल और क्षेत्रीय नियमों में परिवर्तन हो सकता है। उपयोगकर्ताओं को सलाह दी जाती है कि वे आधिकारिक गजट या संबंधित अदालत की रजिस्ट्री से सभी सूचनाओं और गणनाओं का स्वतंत्र सत्यापन करें।",
    ...
    termsPage: {
      ...
      disclaimerBannerText: "लेस लीगल के भीतर प्रदान की गई सामग्री, बेयर एक्ट्स, गणना उपकरण, टैक्स अनुमानक और गाइड केवल सामान्य संदर्भ और शैक्षिक उद्देश्यों के लिए हैं। लेस लीगल कानूनी सलाह, प्रतिनिधित्व या औपचारिक कानूनी राय प्रदान नहीं करता है। कोई अधिवक्ता-क्लाइंट संबंध नहीं बनता है। उपयोगकर्ताओं को योग्य कानूनी पेशेवरों के साथ वैधानिक प्रावधानों का स्वतंत्र रूप से सत्यापन करना चाहिए।",
      ...
      sec3Bullets: [
        "उपलब्ध पास: ₹99 में लाइफटाइम पास (स्पेशल ऑफर)।",
      ...
      sec6Bullets: [
        ...
        "टैक्स अनुमान, भूमि इकाई रूपांतरण, या वैधानिक पाठ में कोई विसंगतियां।",
    ...
    privacyPolicyPage: {
      ...
      sec5Text: "प्रीमियम पास (₹99 में लाइफटाइम पास) खरीदते समय, वित्तीय लेनदेन पेयू Payments Private Limited और/या गूगल प्ले Billing सहित प्रमाणित तृतीय-पक्ष भुगतान गेटवे द्वारा संसाधित किए जाते हैं।",
      sec5Bullets: [
    ...
    refundPolicyPage: {
      ...
      sec3P1: "चूंकि लेस लीगल पास एकमुश्त निश्चित अवधि की खरीदारी हैं और स्वतः नवीनीकृत होने वाले सब्सक्रिप्शन नहीं हैं, इसलिए कोई आवर्ती बिलिंग चक्र नहीं है जिसके लिए भविष्य में रद्दीकरण की आवश्यकता हो।",
      sec3P2: "एक बार जब आपकी वैधता अवधि समाप्त हो जाती है, तो आपका खाता बिना किसी रद्दीकरण कार्रवाई के स्वचालित रूप से मानक पहुंच पर वापस आ जाता है।",
