...
export const translations: Record<Language, TranslationSchema> = {
  ...
  hi: {
    ...
    disclaimerPage: {
      ...
      scopeNotice: "एप्लिकेशन: Less Legal (एंड्रॉइड) • दायरा: शैक्षणिक, संदर्भ एवं डिजिटल उपयोगिता",
      nonGovTitle: "आधिकारिक गैर-सरकारी स्थिति एवं उद्देश्य घोषणा",
      nonGovP1: "Less Legal एक स्वतंत्र सॉफ्टवेयर एप्लिकेशन है। यह भारत सरकार, किसी भी राज्य सरकार, न्यायालय, न्यायाधिकरण, न्यायिक विभाग, वैधानिक प्राधिकरण या अन्य किसी सरकारी निकाय से संबद्ध, समर्थित, स्वीकृत या संचालित नहीं है।",
      ...
      sec2P1: "इस वेबसाइट और Less Legal एंड्रॉइड ऐप पर उपलब्ध सामग्री, टूल्स, कैलकुलेटर, बेयर एक्ट्स, कानूनी शब्दावली परिभाषाएं केवल सामान्य शैक्षिक, संदर्भ और दैनिक उपयोगिता उद्देश्यों के लिए प्रदान की गई हैं।",
      ...
      sec3Highlight: "Less Legal एप्लिकेशन या इस वेबसाइट की कोई भी सामग्री औपचारिक कानूनी सलाह, केस मूल्यांकन या कानूनी प्रतिनिधित्व का गठन नहीं करती है।",
      ...
      aboutLessLegal: "Less Legal के बारे में और जानें →"
    },
    termsPage: {
      badge: "सेवा अनुबंध",
      ...
      appScope: "एप्लिकेशन: Less Legal (एंड्रॉइड)",
      disclaimerBannerTitle: "सूचनात्मक उपयोगिता एवं कोई कानूनी सलाह नहीं अस्वीकरण",
      disclaimerBannerText: "Less Legal के भीतर प्रदान की गई सामग्री, बेयर एक्ट्स, गणना उपकरण, कोर्ट फीस अनुमानक और गाइड केवल सामान्य संदर्भ और शैक्षिक उद्देश्यों के लिए हैं। Less Legal कानूनी सलाह, प्रतिनिधित्व या औपचारिक कानूनी राय प्रदान नहीं करता है। कोई अधिवक्ता-क्लाइंट संबंध नहीं बनता है। उपयोगकर्ताओं को योग्य कानूनी पेशेवरों के साथ वैधानिक प्रावधानों का स्वतंत्र रूप से सत्यापन करना चाहिए।",
      sec1Title: "1. शर्तों की स्वीकृति",
      sec1Text: "Less Legal एंड्रॉइड एप्लिकेशन या इस वेबसाइट को डाउनलोड, इंस्टॉल, एक्सेस या उपयोग करके, आप इन नियमों और शर्तों से बंधे होने के लिए सहमत होते हैं। यदि आप इन शर्तों के किसी भी हिस्से से सहमत नहीं हैं, तो आपको तुरंत एप्लिकेशन का उपयोग बंद कर देना चाहिए।",
      sec2Title: "2. अनुमत उपयोग एवं उपयोगकर्ता उत्तरदायित्व",
      sec2Text: "आपको अपने संगत एंड्रॉइड डिवाइस पर व्यक्तिगत, शैक्षिक या व्यावसायिक उपयोगिता उद्देश्यों के लिए Less Legal का उपयोग करने के लिए एक गैर-अनन्य, गैर-हस्तांतरणीय, प्रतिसंहरणीय लाइसेंस दिया जाता है। आप सहमत हैं कि:",
      sec2Bullets: [
      ...
      sec3Text: "Less Legal विज्ञापन-मुक्त इंटरफ़ेस और पूर्ण उपयोगिता पहुंच प्रदान करने वाले वैकल्पिक सशुल्क प्रीमियम पास प्रदान करता है:",
      sec3Bullets: [
        ...
        "कोई लाइफटाइम दावा नहीं: Less Legal आजीवन एक्सेस पास नहीं बेचता है। वैधता केवल खरीदे गए प्लान की अवधि तक ही सीमित है।"
      ],
      sec4Title: "4. पेमेंट गेटवे एवं लेनदेन प्रोसेसिंग",
      sec4Text: "भुगतान अधिकृत पेमेंट मध्यस्थों जैसे PayU और/या Google Play Billing के माध्यम से संसाधित किए जाते हैं। लेनदेन पूरा करके, आप भुगतान प्रदाता की सेवा की शर्तों से सहमत होते हैं। Less Legal संवेदनशील कार्डधारक डेटा संग्रहीत नहीं करता है।",
      sec5Title: "5. बौद्धिक संपदा",
      sec5Text: "सभी एप्लिकेशन सॉफ़्टवेयर कोड, उपयोगकर्ता इंटरफ़ेस डिज़ाइन, लोगो, ग्राफ़िक्स और टूल्स का संकलन Less Legal की बौद्धिक संपदा हैं। ऐप के भीतर संदर्भित सार्वजनिक वैधानिक बेयर एक्ट्स और आधिकारिक अदालती लिंक उनके संबंधित सरकारी और सार्वजनिक डोमेन रिपॉजिटरी से संबंधित हैं।",
      sec6Title: "6. दायित्व की सीमा",
      sec6Text: "लागू कानून द्वारा अनुमत अधिकतम सीमा तक, Less Legal और इसके डेवलपर्स निम्नलिखित से होने वाले किसी भी प्रत्यक्ष, अप्रत्यक्ष, आकस्मिक या परिणामी नुकसान के लिए उत्तरदायी नहीं होंगे:",
      sec6Bullets: [
    ...
    privacyPolicyPage: {
      ...
      title: "Less Legal एंड्रॉइड ऐप के लिए गोपनीयता नीति",
      effectiveDate: "प्रभावी तिथि: 1 मार्च 2025",
      lastUpdated: "अंतिम अद्यतन: मार्च 2025",
      appScope: "एप्लिकेशन: Less Legal (एंड्रॉइड)",
      summaryTitle: "मुख्य गोपनीयता सारांश",
      summaryText: "Less Legal पारदर्शी, न्यूनतम डेटा प्रथाओं के लिए प्रतिबद्ध है। आपकी संवेदनशील फाइलें (पीडीएफ, केस नोट्स, डायरी रिकॉर्ड) आपके एंड्रॉइड डिवाइस पर स्थानीय रूप से प्रोसेस की जाती हैं। हम आपका व्यक्तिगत डेटा नहीं बेचते हैं। विज्ञापन-मुक्त पास के लिए भुगतान लेनदेन प्रमाणित भुगतान प्रोसेसर (PayU / Google Play Billing) द्वारा सुरक्षित रूप से संभाला जाता है।",
      sec1Title: "1. परिचय एवं दायरा",
      sec1P1: "यह गोपनीयता नीति बताती है कि जब आप एंड्रॉइड ऑपरेटिंग सिस्टम पर हमारे मोबाइल एप्लिकेशन को इंस्टॉल, एक्सेस या उपयोग करते हैं और हमारी आधिकारिक वेबसाइट पर जाते हैं, तो Less Legal ('हम', 'हमारा', या 'एप्लिकेशन') जानकारी को कैसे संभालता है।",
      sec1P2: "Less Legal को डाउनलोड या उपयोग करके, आप इस नीति के अनुसार जानकारी के संग्रह और उपयोग के लिए सहमत होते हैं। यदि आप इस नीति की किसी भी शर्त से सहमत नहीं हैं, तो कृपया एप्लिकेशन का उपयोग न करें।",
      ...
      sec3Text: "जब आप हमारे पीडीएफ टूल्स (मर्ज, स्प्लिट, कंप्रेस, लॉक/अनलॉक) या पीडीएफ रीडर का उपयोग करते हैं, तो दस्तावेज़ प्रोसेसिंग आपके एंड्रॉइड डिवाइस के हार्डवेयर पर ही होती है। Less Legal आपकी पीडीएफ फाइलों की सामग्री को बाहरी क्लाउड सर्वर पर अपलोड, स्टोर या ट्रांसमिट नहीं करता है।",
    ...
    refundPolicyPage: {
      ...
      effectiveDate: "प्रभावी तिथि: 1 मार्च 2025",
      lastUpdated: "अंतिम अद्यतन: मार्च 2025",
      paymentGateways: "भुगतान गेटवे: PayU / Google Play",
      summaryTitle: "प्रीमियम पास के लिए नीति सारांश",
      summaryText: "Less Legal एक निर्दिष्ट वैधता अवधि के लिए विज्ञापन-मुक्त पहुंच प्रदान करने वाले डिजिटल पास प्रदान करता है। चूंकि डिजिटल पास सक्रियण तत्काल लाभ प्रदान करता है, रिफंड नीचे वर्णित पारदर्शी तकनीकी पात्रता मानदंडों द्वारा शासित होते हैं।",
      ...
      cond2Text: "यदि आपका भुगतान PayU / Google Play द्वारा सफलतापूर्वक संसाधित किया गया था लेकिन विज्ञापन-मुक्त पास 24 घंटों के भीतर सक्रिय होने में विफल रहा और हमारी तकनीकी टीम इसे मैन्युअल रूप से सक्रिय नहीं कर सकती है, तो पूर्ण रिफंड शुरू किया जाएगा।",
      sec3Title: "3. रद्दीकरण नियम (कोई ऑटो-डेबिट नहीं)",
      sec3P1: "चूंकि Less Legal पास एकमुश्त निश्चित अवधि की खरीदारी हैं और स्वतः नवीनीकृत होने वाले सब्सक्रिप्शन नहीं हैं, इसलिए कोई आवर्ती मासिक या वार्षिक बिलिंग चक्र नहीं है जिसके लिए भविष्य में रद्दीकरण की आवश्यकता हो।",
      ...
      sec4Bullets: [
        "Less Legal में आपका पंजीकृत खाता ईमेल पता।",
        "पेमेंट गेटवे ट्रांजैक्शन आईडी / ऑर्डर आईडी (PayU या Play Store रसीद से)।",
      ...
      sec5Text: "स्वीकृत रिफंड मूल भुगतान विधि के माध्यम से पेमेंट गेटवे (PayU / Google Play) द्वारा संसाधित किए जाते हैं। आपके जारीकर्ता बैंक या भुगतान प्रदाता के आधार पर, रिफंड की गई राशि आमतौर पर 5 से 7 व्यावसायिक दिनों के भीतर आपके मूल खाते में दिखाई देती है।",
      readTerms: "← सेवा की शर्तें पढ़ें",
